      ...
      <div className="p-4 sm:p-6 lg:p-8 space-y-6">
        ...
        <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-6">
            <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                ...
                <button onClick={() => openModal('history')} className="w-full sm:w-auto bg-white hover:bg-slate-50 text-gray-700 font-bold py-2 px-4 rounded-lg border border-slate-300 shadow-sm transition duration-150">Lihat Histori</button>
            </div>
        </div>
